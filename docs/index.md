...
Zero dependencies beyond the standard library. Apache-2.0. 722 tests on Python 3.10
through 3.13.
...
Neither was caught by 722 tests. Tests check that code does what you specified; they say
