...
**Pointed at seven public datasets it did not produce, it has filed ten
...
Two of the ten are clean bills, recorded with the same care as the defects,
and one is a caution against a finding of ours that did not survive its own
stratification. Everything else here is the machinery that made those visible
